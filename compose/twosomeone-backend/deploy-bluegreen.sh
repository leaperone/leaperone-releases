...
# 也可手动执行：/opt/apps/twosomeone-backend/production/deploy-bluegreen.sh
#
...
#  - flock 串行化（独立于 web 的锁,backend/web 可并行部署）。
...
PROJECT_DIR=/opt/apps/twosomeone-backend/production
